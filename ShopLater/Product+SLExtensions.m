...
- (NSString *)formattedName:(NSString *)name
{
    ...
    name = [name stringByReplacingOccurrencesOfString:@"&reg;" withString:@""];
    
    NSUInteger myLength = [name length];
    NSUInteger ampIndex = [name rangeOfString:@"&" options:NSLiteralSearch].location;
